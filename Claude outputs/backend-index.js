...
// Every 500 in this file routes through here. Previously a failed write
// returned err.message to the caller and left NOTHING in the container log,
// so an INSERT that failed on the server (disk full, locked database,
// read-only mount) was invisible from both ends. This puts the endpoint and
// the SQLite error into `docker compose logs`, which is what survives after
// the fact.
